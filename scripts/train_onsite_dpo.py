"""Train a DPO adapter on augmented on-site alignment preference data."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset-path",
        default=str(ROOT / "data" / "datasets" / "onsite_alignment_dpo_3000.jsonl"),
    )
    parser.add_argument(
        "--output-root",
        default=str(ROOT / "data" / "distilled" / "transformers-dpo-onsite-v1"),
    )
